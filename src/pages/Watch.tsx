...
import { getRecommendedVideos } from "../store/reducers/getRecomendedVideos";
      ...
      {currentPlaying && currentPlaying?.videoId === id && (
        <div className="max-h-screen overflow-hidden">
          ...
          <div className="flex w-full" style={{ height: "92.5vh" }}>
            <div className="flex flex-col  lg:flex-row gap-y-10 gap-x-5 p-7 mt-3 sm:mt-0 mx-0 sm:mx-20 mr-0 w-full overflow-auto">
              <div style={{ maxWidth: "800px" }}>
                <div>
                  <iframe
                    className=" mx-2 sm:mx-0 w-72 h-64 sm:w-[800px] sm:h-[502px]"
                      ...
                      <div className="flex items-center gap-5 mr-5 mt-4">
                        <div>
                          <img
                            ...
                            alt=""
                            className="flex basis-0 rounded-full h-10 w-20 sm:h-10 sm:w-20"
                          />
                        </div>
                        <div className="w-5/6">
